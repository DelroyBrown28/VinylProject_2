# Generated by Django 3.1.2 on 2020-11-26 14:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_formats', models.ManyToManyField(to='cart.FormatVariation')),
                ('primary_genre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='primary_products', to='cart.genre')),
                ('secondary_genre', models.ManyToManyField(blank=True, to='cart.Genre')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.formatvariation')),
